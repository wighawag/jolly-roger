<script lang="ts">
	...
	interface Props {
		 ...
		 *
		 * THIS APP IS WHERE THAT WAS FOUND. It renders two flows, one for the
		 * account connection and one for the payment rail, and the second one is the
		 * one that takes the default (see context/AcrossPages.svelte and
