...
{#snippet icon_spinner6(clazz)}
	<svg viewBox="0 0 32 32" class={clazz}>
		<path
		...
		>
			...
			<span class="px-2">
				<p>
					{greeting.message}
					{#if greeting.pending}
						{@render icon_spinner6("fill-current animate-spin inline h-4 w-4")}
					{/if}
				</p>
			</span>
		</div>
