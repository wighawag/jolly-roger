...
module.exports = {
  ...
  plugins: [
    ...
    ['snowpack-plugin-hmr-inject', {filter: filterFiles({includes: ['src/stores/*']})}],
    ...
    [
      'snowpack-plugin-ipfs',
      {
        ...
        ethLinkErrorRedirect: {redirectTo: 'ipns', nodeURL: 'https://mainnet.infura.io/v3/bc0bdd4eaac640278cdebc3aa91fabe4'},
